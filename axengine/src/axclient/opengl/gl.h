...
void APIENTRY glWindowPos2dv (const GLdouble *p);
void APIENTRY glWindowPos2fv (const GLfloat *p);
void APIENTRY glWindowPos2iv (const GLint *p);
void APIENTRY glWindowPos2sv (const GLshort *p);
...
void APIENTRY glWindowPos3dv (const GLdouble *p);
void APIENTRY glWindowPos3fv (const GLfloat *p);
void APIENTRY glWindowPos3iv (const GLint *p);
void APIENTRY glWindowPos3sv (const GLshort *p);
void APIENTRY glBlendFuncSeparate (GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);
void APIENTRY glFogCoordd (GLdouble fog);
void APIENTRY glFogCoorddv (const GLdouble *fog);
void APIENTRY glFogCoordf (GLfloat fog);
void APIENTRY glFogCoordfv (const GLfloat *fog);
