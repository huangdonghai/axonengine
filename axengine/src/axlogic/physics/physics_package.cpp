...
Primitives HavokModel::getStaticPrims()
{
	return getHitTestPrims();
}


void HavokModel::issueToScene(RenderScene *qscene)
{
	if (!m_package)
		return;
