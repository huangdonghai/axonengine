...
AX_STATDECL(stat_terrainUpdateTime, "Terrain Update Time", Stat::F_Double);
...
AX_STATDECL(stat_numPrimitives, "Primitives", Stat::F_Int);
...
AX_STATDECL(stat_worldEntities, "World Number Entities", Stat::F_Int);
