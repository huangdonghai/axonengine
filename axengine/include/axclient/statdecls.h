...
AX_STATDECL(stat_shaderParamUpdated , "Shader Param Updated", Stat::F_Int | Stat::F_AutoReset);
AX_STATDECL(stat_shaderParamCached , "Shader Param Cached", Stat::F_Int | Stat::F_AutoReset);
AX_STATDECL(stat_shaderParamNotused , "Shader Param Notused", Stat::F_Int | Stat::F_AutoReset);
...
AX_STATDECL(stat_numShadowQuery , "Shadow Query", Stat::F_Int);
