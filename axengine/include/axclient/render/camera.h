...
public:
	...
	static void createCubemapCameras(const RenderCamera &main, const AffineMat &mtx,  RenderCamera result[6], float znear=0.5f, float zfar=16.0f);
	static void createCubemapCameras(const AffineMat &mtx,  RenderCamera result[6], float znear=0.5f, float zfar=16.0f);
