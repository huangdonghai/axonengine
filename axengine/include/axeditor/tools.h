...
protected:
	...
	virtual bool doTransform(const Vector3 &v, int index, Matrix &result) = 0;
...
protected:
	...
	virtual bool doTransform(const Vector3 &v, int index, Matrix &result);
