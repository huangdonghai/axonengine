...
inline Rgba::operator const byte_t*() const
{ return &r; }
...
struct AX_API Color4
{
	...
	explicit Color4(const Rgba &rhs) : r(rhs.r / 255.0f), g(rhs.g/255.0f), b(rhs.b/255.0f), a(rhs.a/255.0f) {}
	~Color4() {}
